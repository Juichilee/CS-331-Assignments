...
def main():
  ...
  NaiveBayes(trainingList, testList, vocabulary, vocabSize)

  vocabulary.append('classlabel')
  outputVectorList('preprocessed_train.txt', vocabulary, trainingList)
  outputVectorList('preprocessed_test.txt', vocabulary, testList)
...
def NaiveBayes(trainingList, testList, vocabulary, vocabSize):
  ...
  trainingAccurracy = Classification(trainingList, pClassLabelTrue, pClassLabelFalse, tableOfPTrueGivenCLTrue, tableOfPTrueGivenCLFalse)

  testAccurracy = Classification(testList, pClassLabelTrue, pClassLabelFalse, tableOfPTrueGivenCLTrue, tableOfPTrueGivenCLFalse)

  with open("results.txt", 'w') as file:
    file.write("Accuracy from training on trainingSet.txt and testing on trainingSet.txt: " + str(trainingAccurracy) + "\n")
    file.write("Accuracy from training on trainingSet.txt and testing on testSet.txt: " + str(testAccurracy) + "\n")
    file.close()
...
def outputVectorList(filename, vocab, vectorList):
  print("OutputVectorList: ", filename)
